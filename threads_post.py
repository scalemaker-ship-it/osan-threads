...
CALENDAR = [
    {"name": "가벼운 안부 (일상)", "detail": "치과 얘기 없이, 이웃에게 요즘 어떻게 지내는지 가볍게 안부를 건네고 소소한 질문으로 마무리하는 수다 글. 특정 요일(월요일 등)은 언급하지 마세요."},
    ...
    {"name": "한 주 응원 (일상)", "detail": "치과 얘기 없이, 이웃들에게 이번 한 주도 수고 많다는 따뜻한 응원과 안부를 건네는 일상 글. 특정 요일(금요일 등)은 단정하지 마세요."},
